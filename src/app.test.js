...
test("Renders show data when menu is run", async () =>{
mockFetchShow.mockResolvedValueOnce(episodeTestData)
  
const {getByText, debug, queryAllByTestId} = render(<App></App>)
const menu = getByText(/select a season/i)
fireEvent.click(menu)
debug()

await waitFor(()=> expect(queryAllByTestId(/Value/i).toHaveLength()))
})